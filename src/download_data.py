...
download_file('https://www.insee.fr/fr/statistiques/fichier/6011070/ensemble.xlsx', input_path + 'INSEE/ensemble.xlsx')
download_file('https://www.insee.fr/fr/statistiques/fichier/2510634/Intercommunalite_Metropole_au_01-01-2022.zip', input_path + 'INSEE/Intercommunalite-Metropole_au_01-01-2022.zip')
unzip(input_path + 'INSEE/Intercommunalite-Metropole_au_01-01-2022.zip', input_path + 'INSEE/')
